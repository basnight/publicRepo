...
Welcome to my awesome public repo! This repository contains all sorts of cool stuff that I've been working on. Feel free to take a look around and use anything you find useful.

# DevOps Toolkit & Infrastructure 
...
- **Schedule**: First Friday of each month at 5:00 UTC
...
- **Features**:
  ...
  - Timezone-aware execution (America/NewYork)
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/basnight/publicRepo/main/ai_devops/cloud-deploy/.gitlab-ci-template.yml'
  - remote: 'https://raw.githubusercontent.com/basnight/publicRepo/main/ai_devops/trivy/.gitlab-ci-template.yml'
```
...
```hcl
module "vpc" {
  source = "git::https://github.com/basnight/publicRepo.git//Terraform/modules/vpc"
  # ... configuration
}
```
...
- **70+** production-ready scripts and templates
- **6** AI-powered DevOps tools
- **Multi-cloud** support (AWS + GCP)
- **10+** reusable Terraform modules
