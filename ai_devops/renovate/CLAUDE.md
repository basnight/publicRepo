...
**Dependencies**:
- Depends on `livelife/io/digital-product/sre/cicd-tools/doppler` CI template for secret management
...
**GitLab Project Path**: Template is hosted at `livelife/io/digital-product/sre/cicd-tools/renovate`
