...
2. **Doppler Secrets**: `RENOVATE_BOT` token configured in Doppler, needed for our gitlab runners to pull release update notes from Github via the SRE SVC Account (svc_sre_digital_product@livelife).
...
```yaml
include:
  - project: 'livelife/io/digital-product/sre/cicd-tools/renovate'
