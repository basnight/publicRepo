...
- Example: `livelife_io_digital-product_data_data-operations_data-models_lc-data-warehouse.md` for the lc-data-warehouse project
...
1. Get the project's `path_with_namespace` (e.g., `livelife/io/digital-product/data/data-operations/data-models/lc-data-warehouse`)
2. Replace slashes with underscores: `livelife_io_digital-product_data_data-operations_data-models_lc-data-warehouse`
